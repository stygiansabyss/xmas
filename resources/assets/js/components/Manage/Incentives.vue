<template>
  <div class="panel panel-default" :class="{ 'panel-primary': incentiveShow }">
      ...
      <form>
        <div v-if="incentive === null">
          <div class="form-group">
            <div class="col-md-12">
              <a href="/incentive/create" class="btn btn-block btn-primary">
        ...
        <div v-if="incentive !== null">
          ...
          <a href="/incentive/reached/{{ incentive.id }}"
