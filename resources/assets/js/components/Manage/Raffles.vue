    ...
    <div class="panel-heading">
      <div class="panel-title clearfix">
        ...
        <div class="pull-right">
          <div v-show="raffle !== null">
            <a class="btn btn-xs btn-inverse"
               v-show="raffle.status == 0"
            ...
            <a href="/raffle/watch/{{ raffle.id }}" class="btn btn-xs btn-warning">
              <i class="fa fa-eye"></i>
            </a>
            <a href="/raffle/winner/{{ raffle.id }}" class="btn btn-xs btn-warning">
      ...
      <div class="btn-group btn-group-justified">
        <div class="btn-group">
          ...
          <ul class="dropdown-menu">
            ...
            <li @click="toggleRaffleStatus(raffle.id, 0)" :class="{ 'active': raffle.status === 0 }"><a>Inactive</a></li>
            <li @click="toggleRaffleStatus(raffle.id, 1)" :class="{ 'active': raffle.status === 1 }"><a>Active</a></li>
            <li @click="toggleRaffleStatus(raffle.id, 2)" :class="{ 'active': raffle.status === 2 }"><a>Finished</a></li>
          </ul>
        </div>
      </div>
    </div>
